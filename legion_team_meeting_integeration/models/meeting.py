                ...
                if client_details.access_token and client_details.refresh_token:
                    ...
                    body = {
                        "message": {
                            ...
                            "body": {
                                "contentType": "HTML",
                                "content": "<div><a>You Are Invited to Meeting</a>""<p>"+self._description+"</p>""</div><dev><ul><li>Meeting URL: <a target=""_blank"" href="+self.team_url+">Join a Team Meeting</a></li></ul></div>"
                                    },
                            "toRecipients": [
                                {
                                    "emailAddress": {
